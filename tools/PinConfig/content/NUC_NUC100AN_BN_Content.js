...
{ f: ['PB.0:0', 'RXD0:1'] },
{ f: ['PB.1:0', 'TXD0:1'] },
{ f: ['PB.2:0', 'RTS0:1', 'nWRL:7'] },
{ f: ['PB.3:0', 'CTS0:1', 'nWRH:7'] },
{ f: ['PB.4:0', 'RXD1:1'] },
{ f: ['PB.5:0', 'TXD1:1'] },
...
'AD0:EBI Address/Data bus bit0 (64-pin package only)',
'AD1:EBI Address/Data bus bit1 (64-pin package only)',
'AD2:EBI Address/Data bus bit2 (64-pin package only)',
'AD3:EBI Address/Data bus bit3 (64-pin package only)',
'AD4:EBI Address/Data bus bit4 (64-pin package only)',
'AD5:EBI Address/Data bus bit5 (64-pin package only)',
'AD6:EBI Address/Data bus bit6 (64-pin package only)',
'AD7:EBI Address/Data bus bit7 (64-pin package only)',
'AD8:EBI Address/Data bus bit8 (64-pin package only)',
'AD9:EBI Address/Data bus bit9 (64-pin package only)',
'AD10:EBI Address/Data bus bit10 (64-pin package only)',
'AD11:EBI Address/Data bus bit11 (64-pin package only)',
'AD12:EBI Address/Data bus bit12 (64-pin package only)',
'AD13:EBI Address/Data bus bit13 (64-pin package only)',
'AD14:EBI Address/Data bus bit14 (64-pin package only)',
'AD15:EBI Address/Data bus bit15 (64-pin package only)',
...
'ALE:EBI address latch enable output pin (64-pin package only)',
...
'LDO:LDO output pin',
'MCLK:EBI external clock output pin (64-pin package only)',
...
'nCS:EBI chip select enable output pin (64-pin package only)',
'nRD:EBI read enable output pin (64-pin package only)',
'nWR:EBI write enable output pin (64-pin package only)',
'nWRH:EBI high byte write enable output pin (64-pin package only)',
'nWRL:EBI low byte write enable output pin (64-pin package only)',
...
{ f: ['PB.0', 'GPB_MFP[0]:0'] },
{ f: ['PB.1', 'GPB_MFP[1]:0'] },
{ f: ['PB.2', 'GPB_MFP[2]:0', 'ALT_MFP[11]:1', 'ALT_MFP[13]:2'] },
{ f: ['PB.3', 'GPB_MFP[3]:0', 'ALT_MFP[11]:1', 'ALT_MFP[14]:2'] },
{ f: ['PB.4', 'GPB_MFP[4]:0'] },
{ f: ['PB.5', 'GPB_MFP[5]:0'] },
...
NUTOOL_PIN.g_cfg_unusedGPIO = {
	...
	"NUC100VD3AN(LQFP100)": function () {
		return this["NUC100VD2AN(LQFP100)"];
	},
	"NUC100VE3AN(LQFP100)": function () {
		return this["NUC100VD2AN(LQFP100)"];
	},
	"NUC120VD2AN(LQFP100)": function () {
		return this["NUC100VD2AN(LQFP100)"];
	},
	"NUC120VD3AN(LQFP100)": function () {
		return this["NUC100VD2AN(LQFP100)"];
	},
	"NUC120VE3AN(LQFP100)": function () {
		return this["NUC100VD2AN(LQFP100)"];
	},
	"NUC100RD3AN(LQFP64)": {
		"PB.14": ["SPISS31"],
	...
	"NUC100RE3AN(LQFP64)": function () {
		return this["NUC100RD3AN(LQFP64)"];
	},
	"NUC120RD3AN(LQFP64)": function () {
		return this["NUC100RD3AN(LQFP64)"];
	},
	"NUC120RE3AN(LQFP64)": function () {
		return this["NUC100RD3AN(LQFP64)"];
	},
	"NUC100LD3AN(LQFP48)": {
		"PB.12": ["AD0"],
	...
	"NUC100LE3AN(LQFP48)": function () {
		return this["NUC100LD3AN(LQFP48)"];
	},
		"NUC120LD3AN(LQFP48)": {
		"PB.12": ["AD0"],
		"PA.11": ["nRD"],
	...
	"NUC120LE3AN(LQFP48)": function () {
		return this["NUC120LD3AN(LQFP48)"];
	},
	"NUC100RC1BN(LQFP64)": {
		"PB.14": ["SPISS31"],
		"PB.10": ["SPISS01"],
	...
	"NUC100RD1BN(LQFP64)": function () {
		return this["NUC100RC1BN(LQFP64)"];
	},
	"NUC100RD2BN(LQFP64)": function () {
		return this["NUC100RC1BN(LQFP64)"];
	},
	"NUC120RC1BN(LQFP64)": function () {
		return this["NUC100RC1BN(LQFP64)"];
	},
	"NUC120RD1BN(LQFP64)": function () {
		return this["NUC100RC1BN(LQFP64)"];
	},
	"NUC120RD2BN(LQFP64)": function () {
		return this["NUC100RC1BN(LQFP64)"];
	},
		"NUC100LC1BN(LQFP48)": {
		"PB.12": ["AD0"],
	...
	"NUC100LD1BN(LQFP48)": function () {
		return this["NUC100LC1BN(LQFP48)"];
	},
	"NUC100LD2BN(LQFP48)": function () {
		return this["NUC100LC1BN(LQFP48)"];
	},
	"NUC120LC1BN(LQFP48)": {
		"PB.12": ["AD0"],
	...
	"NUC120LD1BN(LQFP48)": function () {
		return this["NUC120LC1BN(LQFP48)"];
	},
	"NUC120LD2BN(LQFP48)": function () {
		return this["NUC120LC1BN(LQFP48)"];
	}
};
