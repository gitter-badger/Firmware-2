...
{ f: ['PA.8'] },
{ f: ['PA.9'] },
{ f: ['PA.10', 'I2C1_SDA:SYS_GPA_MFPH_GPA10_MFP_I2C1_SDA@GPA_MFPH', 'SPI1_MISO0:SYS_GPA_MFPH_GPA10_MFP_SPI1_MISO0@GPA_MFPH', 'SPI2_MISO0:SYS_GPA_MFPH_GPA10_MFP_SPI2_MISO0@GPA_MFPH'] },
{ f: ['PA.11', 'I2C1_SCL:SYS_GPA_MFPH_GPA11_MFP_I2C1_SCL@GPA_MFPH', 'SPI1_CLK:SYS_GPA_MFPH_GPA11_MFP_SPI1_CLK@GPA_MFPH', 'SPI2_MOSI0:SYS_GPA_MFPH_GPA11_MFP_SPI2_MOSI0@GPA_MFPH'] },
{ f: ['PA.12', 'PWM0:SYS_GPA_MFPH_GPA12_MFP_PWM0@GPA_MFPH'] },
{ f: ['PA.13', 'PWM1:SYS_GPA_MFPH_GPA13_MFP_PWM1@GPA_MFPH'] },
{ f: ['PA.14', 'PWM2:SYS_GPA_MFPH_GPA14_MFP_PWM2@GPA_MFPH'] },
{ f: ['PA.15', 'PWM3:SYS_GPA_MFPH_GPA15_MFP_PWM3@GPA_MFPH', 'CLKO:SYS_GPA_MFPH_GPA15_MFP_CLKO@GPA_MFPH', 'I2S_MCLK:SYS_GPA_MFPH_GPA15_MFP_I2S_MCLK@GPA_MFPH'] },

{ f: ['PB.0', 'UART0_RXD:SYS_GPB_MFPL_GPB0_MFP_UART0_RXD@GPB_MFPL'] },
{ f: ['PB.1', 'UART0_TXD:SYS_GPB_MFPL_GPB1_MFP_UART0_TXD@GPB_MFPL'] },
{ f: ['PB.2', 'UART0_nRTS:SYS_GPB_MFPL_GPB2_MFP_UART0_nRTS@GPB_MFPL', 'TM2_EXT:SYS_GPB_MFPL_GPB2_MFP_TM2_EXT@GPB_MFPL'] },
{ f: ['PB.3', 'UART0_nCTS:SYS_GPB_MFPL_GPB3_MFP_UART0_nCTS@GPB_MFPL', 'TM3_EXT:SYS_GPB_MFPL_GPB3_MFP_TM3_EXT@GPB_MFPL'] },
{ f: ['PB.4', 'UART1_RXD:SYS_GPB_MFPL_GPB4_MFP_UART1_RXD@GPB_MFPL', 'SPI2_SS0:SYS_GPB_MFPL_GPB4_MFP_SPI2_SS0@GPB_MFPL', 'SPI1_SS1:SYS_GPB_MFPL_GPB4_MFP_SPI1_SS1@GPB_MFPL'] },
{ f: ['PB.5', 'UART1_TXD:SYS_GPB_MFPL_GPB5_MFP_UART1_TXD@GPB_MFPL', 'SPI2_CLK:SYS_GPB_MFPL_GPB5_MFP_SPI2_CLK@GPB_MFPL'] },
{ f: ['PB.6', 'UART1_nRTS:SYS_GPB_MFPL_GPB6_MFP_UART1_nRTS@GPB_MFPL', 'SPI2_MOSI0:SYS_GPB_MFPL_GPB6_MFP_SPI2_MOSI0@GPB_MFPL'] },
{ f: ['PB.7', 'UART1_nCTS:SYS_GPB_MFPL_GPB7_MFP_UART1_nCTS@GPB_MFPL', 'SPI2_MISO0:SYS_GPB_MFPL_GPB7_MFP_SPI2_MISO0@GPB_MFPL'] },
{ f: ['PB.8', 'TM0:SYS_GPB_MFPH_GPB8_MFP_TM0@GPB_MFPH'] },
{ f: ['PB.9', 'TM1:SYS_GPB_MFPH_GPB9_MFP_TM1@GPB_MFPH', 'SPI1_SS1:SYS_GPB_MFPH_GPB9_MFP_SPI1_SS1@GPB_MFPH', 'PWM1:SYS_GPB_MFPH_GPB9_MFP_PWM1@GPB_MFPH'] },
{ f: ['PB.10', 'TM2:SYS_GPB_MFPH_GPB10_MFP_TM2@GPB_MFPH', 'SPI0_SS1:SYS_GPB_MFPH_GPB10_MFP_SPI0_SS1@GPB_MFPH'] },
{ f: ['PB.11'] },
{ f: ['PB.12', 'SPI1_SS0:SYS_GPB_MFPH_GPB12_MFP_SPI1_SS0@GPB_MFPH', 'CLKO:SYS_GPB_MFPH_GPB12_MFP_CLKO@GPB_MFPH'] },
{ f: ['PB.13'] },
{ f: ['PB.14', 'INT0:SYS_GPB_MFPH_GPB14_MFP_INT0@GPB_MFPH'] },
{ f: ['PB.15', 'INT1:SYS_GPB_MFPH_GPB15_MFP_INT1@GPB_MFPH', 'TM0_EXT:SYS_GPB_MFPH_GPB15_MFP_TM0_EXT@GPB_MFPH'] },

{ f: ['PC.0', 'SPI0_SS0:SYS_GPC_MFPL_GPC0_MFP_SPI0_SS0@GPC_MFPL', 'I2S_LRCLK:SYS_GPC_MFPL_GPC0_MFP_I2S_LRCLK@GPC_MFPL'] },
{ f: ['PC.1', 'SPI0_CLK:SYS_GPC_MFPL_GPC1_MFP_SPI0_CLK@GPC_MFPL', 'I2S_BCLK:SYS_GPC_MFPL_GPC1_MFP_I2S_BCLK@GPC_MFPL'] },
{ f: ['PC.2', 'SPI0_MISO0:SYS_GPC_MFPL_GPC2_MFP_SPI0_MISO0@GPC_MFPL', 'I2S_DI:SYS_GPC_MFPL_GPC2_MFP_I2S_DI@GPC_MFPL'] },
{ f: ['PC.3', 'SPI0_MOSI0:SYS_GPC_MFPL_GPC3_MFP_SPI0_MOSI0@GPC_MFPL', 'I2S_DO:SYS_GPC_MFPL_GPC3_MFP_I2S_DO@GPC_MFPL'] },
{ f: ['PC.4', 'SPI0_MISO1:SYS_GPC_MFPL_GPC4_MFP_SPI0_MISO1@GPC_MFPL', 'UART0_RXD:SYS_GPC_MFPL_GPC4_MFP_UART0_RXD@GPC_MFPL'] },
{ f: ['PC.5', 'SPI0_MOSI1:SYS_GPC_MFPL_GPC5_MFP_SPI0_MOSI1@GPC_MFPL', 'UART0_TXD:SYS_GPC_MFPL_GPC5_MFP_UART0_TXD@GPC_MFPL'] },
{ f: ['PC.6'] },
{ f: ['PC.7'] },
{ f: ['PC.8', 'SPI1_SS0:SYS_GPC_MFPH_GPC8_MFP_SPI1_SS0@GPC_MFPH', 'PWM0:SYS_GPC_MFPH_GPC8_MFP_PWM0@GPC_MFPH'] },
{ f: ['PC.9', 'SPI1_CLK:SYS_GPC_MFPH_GPC9_MFP_SPI1_CLK@GPC_MFPH'] },
{ f: ['PC.10', 'SPI1_MISO0:SYS_GPC_MFPH_GPC10_MFP_SPI1_MISO0@GPC_MFPH'] },
{ f: ['PC.11', 'SPI1_MOSI0:SYS_GPC_MFPH_GPC11_MFP_SPI1_MOSI0@GPC_MFPH'] },
{ f: ['PC.12', 'SPI1_MISO1:SYS_GPC_MFPH_GPC12_MFP_SPI1_MISO1@GPC_MFPH', 'I2S_MCLK:SYS_GPC_MFPH_GPC12_MFP_I2S_MCLK@GPC_MFPH', 'PWM2:SYS_GPC_MFPH_GPC12_MFP_PWM2@GPC_MFPH'] },
{ f: ['PC.13', 'SPI1_MOSI1:SYS_GPC_MFPH_GPC13_MFP_SPI1_MOSI1@GPC_MFPH', 'CLKO:SYS_GPC_MFPH_GPC13_MFP_CLKO@GPC_MFPH', 'PWM3:SYS_GPC_MFPH_GPC13_MFP_PWM3@GPC_MFPH'] },
{ f: ['PC.14'] },
{ f: ['PC.15'] },

{ f: ['PD.0', 'SPI2_SS0:SYS_GPD_MFPL_GPD0_MFP_SPI2_SS0@GPD_MFPL', 'ADC0:SYS_GPD_MFPL_GPD0_MFP_ADC0@GPD_MFPL'] },
{ f: ['PD.1', 'SPI0_SS1:SYS_GPD_MFPL_GPD1_MFP_SPI0_SS1@GPD_MFPL', 'SPI2_CLK:SYS_GPD_MFPL_GPD1_MFP_SPI2_CLK@GPD_MFPL', 'ADC1:SYS_GPD_MFPL_GPD1_MFP_ADC1@GPD_MFPL'] },
{ f: ['PD.2', 'SPI0_MISO1:SYS_GPD_MFPL_GPD2_MFP_SPI0_MISO1@GPD_MFPL', 'SPI2_MISO0:SYS_GPD_MFPL_GPD2_MFP_SPI2_MISO0@GPD_MFPL', 'ADC2:SYS_GPD_MFPL_GPD2_MFP_ADC2@GPD_MFPL'] },
{ f: ['PD.3', 'SPI0_MOSI1:SYS_GPD_MFPL_GPD3_MFP_SPI0_MOSI1@GPD_MFPL', 'SPI2_MOSI0:SYS_GPD_MFPL_GPD3_MFP_SPI2_MOSI0@GPD_MFPL', 'ADC3:SYS_GPD_MFPL_GPD3_MFP_ADC3@GPD_MFPL'] },
{ f: ['PD.4', 'SPI2_MISO1:SYS_GPD_MFPL_GPD4_MFP_SPI2_MISO1@GPD_MFPL', 'ADC4:SYS_GPD_MFPL_GPD4_MFP_ADC4@GPD_MFPL'] },
{ f: ['PD.5', 'SPI2_MOSI1:SYS_GPD_MFPL_GPD5_MFP_SPI2_MOSI1@GPD_MFPL', 'ADC5:SYS_GPD_MFPL_GPD5_MFP_ADC5@GPD_MFPL'] },
{ f: ['PD.6'] },
{ f: ['PD.7'] },
{ f: ['PD.8', 'SPI1_MOSI0:SYS_GPD_MFPH_GPD8_MFP_SPI1_MOSI0@GPD_MFPH'] },
{ f: ['PD.9'] },
{ f: ['PD.10', 'CLKO:SYS_GPD_MFPH_GPD10_MFP_CLKO@GPD_MFPH'] },
{ f: ['PD.11', 'INT1:SYS_GPD_MFPH_GPD11_MFP_INT1@GPD_MFPH'] },
{ f: ['PD.12'] },
{ f: ['PD.13'] },
{ f: ['PD.14'] },
{ f: ['PD.15'] },
...
{ f: ['PF.0', 'XT1_OUT:SYS_GPF_MFPL_GPF0_MFP_XT1_OUT@GPF_MFPL'] },
{ f: ['PF.1', 'XT1_IN:SYS_GPF_MFPL_GPF1_MFP_XT1_IN@GPF_MFPL'] },
{ f: ['PF.2', 'PS2_DAT:SYS_GPF_MFPL_GPF2_MFP_PS2_DAT@GPF_MFPL', 'I2C0_SDA:SYS_GPF_MFPL_GPF2_MFP_I2C0_SDA@GPF_MFPL', 'ADC6:SYS_GPF_MFPL_GPF2_MFP_ADC6@GPF_MFPL'] },
{ f: ['PF.3', 'PS2_CLK:SYS_GPF_MFPL_GPF3_MFP_PS2_CLK@GPF_MFPL', 'I2C0_SCL:SYS_GPF_MFPL_GPF3_MFP_I2C0_SCL@GPF_MFPL', 'ADC7:SYS_GPF_MFPL_GPF3_MFP_ADC7@GPF_MFPL'] }
];
