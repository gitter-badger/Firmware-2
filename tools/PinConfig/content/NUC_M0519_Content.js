...
{ name: "M0519SD2AE", pkg: "LQFP64" },

{ name: "M0519LE3AE", pkg: "LQFP48" },
{ name: "M0519LD2AE", pkg: "LQFP48" }
];
...
{ f: ['P0.0', 'EPWM0_CH0:SYS_MFP_P00_EPWM0_CH0@P0_MFP', 'ECAP1_IC0:SYS_MFP_P00_ECAP1_IC0@P0_MFP'] },
{ f: ['P0.1', 'EPWM0_CH1:SYS_MFP_P01_EPWM0_CH1@P0_MFP', 'ECAP1_IC1:SYS_MFP_P01_ECAP1_IC1@P0_MFP'] },
{ f: ['P0.2', 'EPWM0_CH2:SYS_MFP_P02_EPWM0_CH2@P0_MFP', 'ECAP1_IC2:SYS_MFP_P02_ECAP1_IC2@P0_MFP'] },
{ f: ['P0.3', 'EPWM0_CH3:SYS_MFP_P03_EPWM0_CH3@P0_MFP', 'STADC:SYS_MFP_P03_STADC@P0_MFP'] },
{ f: ['P0.4', 'EPWM0_CH4:SYS_MFP_P04_EPWM0_CH4@P0_MFP'] },
{ f: ['P0.5', 'EPWM0_CH5:SYS_MFP_P05_EPWM0_CH5@P0_MFP'] },
{ f: ['P0.6', 'EPWM0_BRAKE1:SYS_MFP_P06_EPWM0_BRAKE1@P0_MFP'] },
{ f: ['P0.7', 'STADC:SYS_MFP_P07_STADC@P0_MFP'] },

{ f: ['P1.0', 'EPWM1_CH0:SYS_MFP_P10_EPWM1_CH0@P1_MFP'] },
{ f: ['P1.1', 'EPWM1_CH1:SYS_MFP_P11_EPWM1_CH1@P1_MFP'] },
{ f: ['P1.2', 'EPWM1_CH2:SYS_MFP_P12_EPWM1_CH2@P1_MFP'] },
{ f: ['P1.3', 'EPWM1_CH3:SYS_MFP_P13_EPWM1_CH3@P1_MFP'] },
{ f: ['P1.4', 'EPWM1_CH4:SYS_MFP_P14_EPWM1_CH4@P1_MFP'] },
{ f: ['P1.5', 'EPWM1_CH5:SYS_MFP_P15_EPWM1_CH5@P1_MFP'] },
{ f: ['P1.6', 'EPWM0_BRAKE0:SYS_MFP_P16_EPWM0_BRAKE0@P1_MFP'] },
{ f: ['P1.7', 'EPWM1_BRAKE0:SYS_MFP_P17_EPWM1_BRAKE0@P1_MFP'] },

{ f: ['P2.0', 'SPI2_MOSI:SYS_MFP_P20_SPI2_MOSI@P2_MFP', 'ACMP2_O:SYS_MFP_P20_ACMP2_O@P2_MFP'] },
{ f: ['P2.1', 'ECAP0_IC2:SYS_MFP_P21_ECAP0_IC2@P2_MFP'] },
{ f: ['P2.2', 'ECAP0_IC1:SYS_MFP_P22_ECAP0_IC1@P2_MFP'] },
{ f: ['P2.3', 'ECAP0_IC0:SYS_MFP_P23_ECAP0_IC0@P2_MFP'] },
{ f: ['P2.4'] },
{ f: ['P2.5'] },
{ f: ['P2.6', 'SPI0_SS:SYS_MFP_P26_SPI0_SS@P2_MFP', 'UART1_nCTS:SYS_MFP_P26_UART1_nCTS@P2_MFP'] },
{ f: ['P2.7', 'SPI0_CLK:SYS_MFP_P27_SPI0_CLK@P2_MFP', 'UART1_nRTS:SYS_MFP_P27_UART1_nRTS@P2_MFP'] },

{ f: ['P3.0', 'UART0_RXD:SYS_MFP_P30_UART0_RXD@P3_MFP', 'CLKO:SYS_MFP_P30_CLKO@P3_MFP'] },
{ f: ['P3.1', 'UART0_TXD:SYS_MFP_P31_UART0_TXD@P3_MFP', 'ACMP0_O:SYS_MFP_P31_ACMP0_O@P3_MFP'] },
{ f: ['P3.2', 'INT0:SYS_MFP_P32_INT0@P3_MFP'] },
{ f: ['P3.3', 'INT1:SYS_MFP_P33_INT1@P3_MFP'] },
{ f: ['P3.4', 'TM0:SYS_MFP_P34_TM0@P3_MFP', 'I2C0_SDA:SYS_MFP_P34_I2C0_SDA@P3_MFP'] },
{ f: ['P3.5', 'TM1:SYS_MFP_P35_TM1@P3_MFP', 'I2C0_SCL:SYS_MFP_P35_I2C0_SCL@P3_MFP'] },
{ f: ['P3.6'] },
{ f: ['P3.7'] },

{ f: ['P4.0', 'ECAP1_IC0:SYS_MFP_P40_ECAP1_IC0@P4_MFP'] },
{ f: ['P4.1', 'ECAP1_IC1:SYS_MFP_P41_ECAP1_IC1@P4_MFP'] },
{ f: ['P4.2', 'ECAP1_IC2:SYS_MFP_P42_ECAP1_IC2@P4_MFP'] },
{ f: ['P4.3'] },
{ f: ['P4.4'] },
{ f: ['P4.5'] },
{ f: ['P4.6', 'TM2:SYS_MFP_P46_TM2@P4_MFP'] },
{ f: ['P4.7', 'TM3:SYS_MFP_P47_TM3@P4_MFP'] },

{ f: ['P5.0', 'SPI0_MOSI:SYS_MFP_P50_SPI0_MOSI@P5_MFP', 'UART0_nRTS:SYS_MFP_P50_UART0_nRTS@P5_MFP', 'I2C0_SCL:SYS_MFP_P50_I2C0_SCL@P5_MFP'] },
{ f: ['P5.1', 'SPI0_MISO:SYS_MFP_P51_SPI0_MISO@P5_MFP', 'UART0_nCTS:SYS_MFP_P51_UART0_nCTS@P5_MFP', 'I2C0_SDA:SYS_MFP_P51_I2C0_SDA@P5_MFP'] },
{ f: ['P5.2', 'SPI2_MISO:SYS_MFP_P52_SPI2_MISO@P5_MFP', 'ACMP1_O:SYS_MFP_P52_ACMP1_O@P5_MFP'] },
{ f: ['P5.3', 'SPI2_CLK:SYS_MFP_P53_SPI2_CLK@P5_MFP'] },
{ f: ['P5.4', 'SPI2_SS:SYS_MFP_P54_SPI2_SS@P5_MFP'] },
{ f: ['P5.5', 'CLKO:SYS_MFP_P55_CLKO@P5_MFP'] },
{ f: ['P5.6', 'BPWM0_CH0:SYS_MFP_P56_BPWM0_CH0@P5_MFP'] },
{ f: ['P5.7', 'BPWM0_CH1:SYS_MFP_P57_BPWM0_CH1@P5_MFP'] },

{ f: ['P6.0', 'EADC0_CH0:SYS_MFP_P60_EADC0_CH0@P6_MFP'] },
{ f: ['P6.1', 'EADC0_CH1:SYS_MFP_P61_EADC0_CH1@P6_MFP'] },
{ f: ['P6.2', 'EADC0_CH2:SYS_MFP_P62_EADC0_CH2@P6_MFP'] },
{ f: ['P6.3', 'EADC0_CH3:SYS_MFP_P63_EADC0_CH3@P6_MFP'] },
{ f: ['P6.4', 'EADC0_CH4_and_ACMP1_N:SYS_MFP_P64_EADC0_CH4@P6_MFP', 'EADC0_CH4:SYS_MFP_P64_EADC0_CH4@P6_MFP', 'ACMP1_N:SYS_MFP_P64_ACMP1_N@P6_MFP'] },
{ f: ['P6.5', 'EADC0_CH5_and_ACMP1_P:SYS_MFP_P65_EADC0_CH5@P6_MFP', 'EADC0_CH5:SYS_MFP_P65_EADC0_CH5@P6_MFP', 'ACMP1_P:SYS_MFP_P65_ACMP1_P@P6_MFP'] },
{ f: ['P6.6', 'EADC0_CH6:SYS_MFP_P66_EADC0_CH6@P6_MFP'] },
{ f: ['P6.7', 'EADC0_CH7:SYS_MFP_P67_EADC0_CH7@P6_MFP'] },

{ f: ['P7.0', 'EADC1_CH0:SYS_MFP_P70_EADC1_CH0@P7_MFP'] },
{ f: ['P7.1', 'EADC1_CH1:SYS_MFP_P71_EADC1_CH1@P7_MFP'] },
{ f: ['P7.2', 'EADC1_CH2:SYS_MFP_P72_EADC1_CH2@P7_MFP'] },
{ f: ['P7.3', 'EADC1_CH3:SYS_MFP_P73_EADC1_CH3@P7_MFP'] },
{ f: ['P7.4', 'EADC1_CH4_and_ACMP2_N:SYS_MFP_P74_EADC1_CH4@P7_MFP', 'EADC1_CH4:SYS_MFP_P74_EADC1_CH4@P7_MFP', 'ACMP2_N:SYS_MFP_P74_ACMP2_N@P7_MFP'] },
{ f: ['P7.5', 'EADC1_CH5_and_ACMP2_P:SYS_MFP_P75_EADC1_CH5@P7_MFP', 'EADC1_CH5:SYS_MFP_P75_EADC1_CH5@P7_MFP', 'ACMP2_P:SYS_MFP_P75_ACMP2_P@P7_MFP'] },
{ f: ['P7.6', 'EADC1_CH6:SYS_MFP_P76_EADC1_CH6@P7_MFP'] },
{ f: ['P7.7', 'EADC1_CH7:SYS_MFP_P77_EADC1_CH7@P7_MFP'] },

{ f: ['P8.0', 'OP0_P:SYS_MFP_P80_OP0_P@P8_MFP'] },
{ f: ['P8.1', 'OP0_N:SYS_MFP_P81_OP0_N@P8_MFP'] },
{ f: ['P8.2', 'OP0_O:SYS_MFP_P82_OP0_O@P8_MFP'] },
{ f: ['P8.3', 'ACMP0_N:SYS_MFP_P83_ACMP0_N@P8_MFP'] },
{ f: ['P8.4', 'ACMP0_P:SYS_MFP_P84_ACMP0_P@P8_MFP'] },
{ f: ['P8.5'] },
{ f: ['P8.6'] },
{ f: ['P8.7', 'ACMP0_O:SYS_MFP_P87_ACMP0_O@P8_MFP'] },

{ f: ['P9.0', 'OP1_O:SYS_MFP_P90_OP1_O@P9_MFP'] },
{ f: ['P9.1', 'OP1_N:SYS_MFP_P91_OP1_N@P9_MFP'] },
{ f: ['P9.2', 'OP1_P:SYS_MFP_P92_OP1_P@P9_MFP'] },
{ f: ['P9.3', 'EPWM1_BRAKE1:SYS_MFP_P93_EPWM1_BRAKE1@P9_MFP'] },
{ f: ['P9.4', 'SPI1_CLK:SYS_MFP_P94_SPI1_CLK@P9_MFP'] },
{ f: ['P9.5', 'SPI1_MISO:SYS_MFP_P95_SPI1_MISO@P9_MFP'] },
{ f: ['P9.6', 'SPI1_MOSI:SYS_MFP_P96_SPI1_MOSI@P9_MFP'] },
{ f: ['P9.7', 'SPI1_SS:SYS_MFP_P97_SPI1_SS@P9_MFP'] },

{ f: ['PA.0', 'UART1_TXD:SYS_MFP_PA0_UART1_TXD@PA_MFP', 'I2C0_SDA:SYS_MFP_PA0_I2C0_SDA@PA_MFP'] },
{ f: ['PA.1', 'UART1_RXD:SYS_MFP_PA1_UART1_RXD@PA_MFP', 'I2C0_SCL:SYS_MFP_PA1_I2C0_SCL@PA_MFP'] }
];
